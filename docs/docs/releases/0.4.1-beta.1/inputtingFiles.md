...
[Previous: Working With PHAT Projects](https://chgibb.github.io/PHATDocs/docs/releases/0.4.1-beta.1/projects)

![PHAT Input Button](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputButton.png)
...
![PHAT Input Reads](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputReads2.png)
![PHAT Input Browse Reads](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputBrowseReads.png)
![PHAT Input Reads Success](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputReadsIn.png) 
...
![PHAT Input Browse Refs](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputBrowseRefs.png)
![PHAT Input Index Refs](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/IndexedRef.png)
...
![PHAT Input Selected](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputSelected.png)
...
![PHAT Input Import](https://chgibb.github.io//PHATDocs/docs/releases/0.4.1-beta.1/InputImport.png)
...
[Next: Running Quality Control (QC) Reports](https://chgibb.github.io/PHATDocs/docs/releases/0.4.1-beta.1/QCReports)
...
See: [file module](https://github.com/chgibb/PHAT/blob/0.4.1-beta.1/src/req/file.ts), [file import operation](https://github.com/chgibb/PHAT/blob/0.4.1-beta.1/src/req/operations/ImportFileIntoProject.ts).
