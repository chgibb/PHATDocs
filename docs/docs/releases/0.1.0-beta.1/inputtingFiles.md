...
[Previous: Working With PHAT Projects](https://chgibb.github.io/PHATDocs/docs/releases/0.1.0-beta.1/projects)
...
[Next: Running Quality Control (QC) Reports](https://chgibb.github.io/PHATDocs/docs/releases/0.1.0-beta.1/QCReports)
...
See: [file module](https://github.com/chgibb/PHAT/blob/0.1.0-beta.1/src/req/file.ts), [file import operation](https://github.com/chgibb/PHAT/blob/0.1.0-beta.1/src/req/operations/ImportFileIntoProject.ts).
