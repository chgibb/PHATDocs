...
[Previous: Circular Visualization](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/circularVisualization)

![PHAT Align Button](https://chgibb.github.io//PHATDocs/docs/releases/0.9.2/AlignButton.png)
![PHAT Circ Button](https://chgibb.github.io//PHATDocs/docs/releases/0.9.2/CircButton.png)
![PHAT Output Button](https://chgibb.github.io//PHATDocs/docs/releases/0.9.2/OutputButton.png)
...
![Figure Actions](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/figureActions1.png)


![Select Sequence1](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/selectSequence1.png)
...
![Select Sequence2](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/selectSequence2.png)
...
![BLAST Runs1](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/alignBLASTRuns1.png)
...
![BLAST Runs2](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/alignBLASTRuns2.png)

Selecting a column will give a read by read breakdown.

![BLAST Runs3](https://chgibb.github.io/PHATDocs/docs/releases/0.9.2/alignBLASTRuns3.png)
