...
# Documentation for 0.0.50
## Contents
1. [How to Get PHAT](https://chgibb.github.io/PHATDocs/docs/releases/0.0.50/howToGetPHAT)

### Application Architecture
1. [Overview](https://chgibb.github.io/PHATDocs/docs/releases/0.0.50/archOverview)

2. [Repository Structure](https://chgibb.github.io/PHATDocs/docs/releases/0.0.50/repoStructure)