...
[Previous: Running Alignments](https://chgibb.github.io/PHATDocs/docs/releases/0.7.11-beta.1/runningAlignments)

![PHAT Output Button](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputButton.png)
...
![PHAT Output QC](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputQC.png)
...
![PHAT Output Options](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputOptions.png)

![PHAT Output Align](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputAlign.png)
...
![PHAT Output Pileup](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputPileup.png)
...
![PHAT Output Align Summary](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputAlignSum.png)
...
![PHAT Output SNPs](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputSNP.png)

![PHAT Output SNP pileup](https://chgibb.github.io//PHATDocs/docs/releases/0.7.11-beta.1/OutputSNPpileup.png)
...
[Next: Circular Visualization](https://chgibb.github.io/PHATDocs/docs/releases/0.7.11-beta.1/circularVisualization)
