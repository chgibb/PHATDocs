...
![PHAT Update Pop-up](https://chgibb.github.io//PHATDocs/docs/releases/0.4.0-beta.1/UpdatePopup.png)
...
![PHAT Stable vs Beta](https://chgibb.github.io//PHATDocs/docs/releases/0.4.0-beta.1/StableBetav2.png)

[Next: Working With PHAT Projects](https://chgibb.github.io/PHATDocs/docs/releases/0.4.0-beta.1/projects)
...
See also: [check for update operation](https://github.com/chgibb/PHAT/blob/0.4.0-beta.1/src/req/operations/CheckForUpdate.ts), [download and install update operation](https://github.com/chgibb/PHAT/blob/0.4.0-beta.1/src/req/operations/DownloadAndInstallUpdate.ts). Update installation is handled very differently depending on the platform. See notes in the source code.
