...
[Previous: Running Quality Control (QC) Reports](https://chgibb.github.io/PHATDocs/docs/releases/0.1.4-beta.1/QCReports)

![PHAT Align Button](https://chgibb.github.io//PHATDocs/docs/releases/0.1.4-beta.1/AlignButton.png)
...
![PHAT Align](https://chgibb.github.io//PHATDocs/docs/releases/0.1.4-beta.1/AlignSelected.png)
...
[Next: Reports and Analyses](https://chgibb.github.io/PHATDocs/docs/releases/0.1.4-beta.1/reportsAndAnalyses)

# About Running Alignments
See: [Class for information about a completed alignment](https://github.com/chgibb/PHAT/blob/0.1.4-beta.1/src/req/alignData.ts), [alignment operation](https://github.com/chgibb/PHAT/blob/0.1.4-beta.1/src/req/operations/RunAlignment.ts).
