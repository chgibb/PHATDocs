...
[Previous: Running Alignments](https://chgibb.github.io/PHATDocs/docs/releases/0.12.0-beta.3/runningAlignments)
...
![PHAT Output QC](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputQC.png)
...
![PHAT Output Options](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputOptions.png)

![PHAT Output Align](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputAlign.png)
...
![PHAT Output Pileup](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputPileup.png)
...
![PHAT Output Align Summary](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputAlignSum.png)
...
![PHAT Output SNPs](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputSNP.png)

![PHAT Output SNP pileup](https://chgibb.github.io//PHATDocs/docs/releases/0.12.0-beta.3/OutputSNPpileup.png)
...
[Next: Circular Visualization](https://chgibb.github.io/PHATDocs/docs/releases/0.12.0-beta.3/circularVisualization)
