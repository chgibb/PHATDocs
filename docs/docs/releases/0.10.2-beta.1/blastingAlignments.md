...
[Previous: Circular Visualization](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/circularVisualization)
...
![PHAT Output Button](https://chgibb.github.io//PHATDocs/docs/releases/0.10.2-beta.1/OutputButton.png)
...
![Figure Actions](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/figureActions1.png)


![Select Sequence1](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/selectSequence1.png)
...
![Select Sequence2](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/selectSequence2.png)
...
![BLAST Runs1](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/alignBLASTRuns1.png)
...
![BLAST Runs2](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/alignBLASTRuns2.png)

Selecting a column will give a read by read breakdown.

![BLAST Runs3](https://chgibb.github.io/PHATDocs/docs/releases/0.10.2-beta.1/alignBLASTRuns3.png)
