...
[Previous: Working With PHAT Projects](https://chgibb.github.io/PHATDocs/docs/releases/0.5.0-beta.4/projects)

![PHAT Input Button](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputButton.png)
...
![PHAT Input Reads](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputReads2.png)
![PHAT Input Browse Reads](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputBrowseReads.png)
![PHAT Input Reads Success](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputReadsIn.png) 
...
![PHAT Input Browse Refs](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputBrowseRefs.png)
![PHAT Input Index Refs](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/IndexedRef.png)
...
![PHAT Input Selected](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputSelected.png)
...
![PHAT Input Import](https://chgibb.github.io//PHATDocs/docs/releases/0.5.0-beta.4/InputImport.png)
...
[Next: Running Quality Control (QC) Reports](https://chgibb.github.io/PHATDocs/docs/releases/0.5.0-beta.4/QCReports)
...
See: [file module](https://github.com/chgibb/PHAT/blob/0.5.0-beta.4/src/req/file.ts), [file import operation](https://github.com/chgibb/PHAT/blob/0.5.0-beta.4/src/req/operations/ImportFileIntoProject.ts).
