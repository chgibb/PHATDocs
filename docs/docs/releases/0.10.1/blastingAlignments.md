...
[Previous: Circular Visualization](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/circularVisualization)

![PHAT Align Button](https://chgibb.github.io//PHATDocs/docs/releases/0.10.1/AlignButton.png)
...
![Figure Actions](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/figureActions1.png)


![Select Sequence1](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/selectSequence1.png)
...
![Select Sequence2](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/selectSequence2.png)
...
![BLAST Runs1](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/alignBLASTRuns1.png)
...
![BLAST Runs2](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/alignBLASTRuns2.png)

Selecting a column will give a read by read breakdown.

![BLAST Runs3](https://chgibb.github.io/PHATDocs/docs/releases/0.10.1/alignBLASTRuns3.png)
